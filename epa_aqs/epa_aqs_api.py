...
missed = [] # Stores state-months which do not come through the API
    ...
    for year in range(2010,2021):
        ...
        for month in months:
            ...
            try: # For certain pollutant-state-months the data does not pull through and must be collected manually
                ...
                url = url0 + email + url1 + key + url2 + '42401' + url3 + bdate + url4 + edate + url5 + state # Define url
                ...
                with open(filepath + 'SO2' + '__' + state + '__' + str(year) + '__' + month + '.txt', 'a') as file:
                ...
                missed.append(str(state) + ' :: ' + str(month) + '/' + str(year))
